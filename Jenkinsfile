pipeline {
    ...
    stages {
        stage('Clone repository') {
            steps {
                git branch: 'main', url: 'https://github.com/oneadie/Lanko_Scripts.git'
            }
        }
        stage('Download DEB package') {
            steps {
                sh '''
                    curl -L https://github.com/oneadie/Lanko_Scripts/raw/main/packages/count-files_1.0-2_amd64.deb -o /tmp/count-files_1.0-2_amd64.deb
                '''
            }
        }
        stage('Install DEB') {
